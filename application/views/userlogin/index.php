	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<form class="login100-form validate-form" action="<?php echo base_url(); ?>index.php/logintypical" method="post">
					<center><img src='<?php echo base_url(); ?>assets/images/logo-new-no-background-2.png' style="width: 300px;"></center><br>
					...
					<div class="wrap-input100 validate-input" data-validate="Password is required">
                        ...
                        <span class="focus-input100"></span>
                        <span class="label-input100">Password</span>
                        <span class="btn-show-pass" onclick="togglePassword()" style="position: absolute; right: 15px; top: 50%; transform: translateY(-50%); cursor: pointer;">
